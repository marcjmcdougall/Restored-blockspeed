...
/*
Plugin Name: MyFontsWebfontsKit #3575283
...
add_action( 'admin_init', array('MyFontsInstaller_3575283','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_3575283','mffonts_loadupWebfonts' ));