...
add_action('wp_ajax_stm_get_thumbnail', 'stm_get_thumbnail');
...
function stm_output_vars()
{
	...
	$hbs = array(
		//'startup' => esc_html__('Startup', 'pearl_header_builder'),
		//'store' => esc_html__('Store', 'pearl_header_builder'),
		//'portfolio' => esc_html__('Portfolio', 'pearl_header_builder'),
