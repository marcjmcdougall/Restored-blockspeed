...
<div class="stm-events_map<?php echo esc_attr( $css_class ); ?>">
    <script type="text/javascript">
        ...
        function loadScript() {
            ...
            script.src = "https://maps.googleapis.com/maps/api/js?key=<?php echo crypterio_sanitize_text_field($google_api_key ); ?>&v=3.exp&signed_in=true&callback=initialize_map_"+mapId+"&language=en";
            <?php } else { ?>
