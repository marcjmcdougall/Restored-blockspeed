...
<?php if( $type == 'type_1' ){ ?>
	<div class="<?php echo esc_attr(trim($css_class)); ?>">
		<span class="vc_sep_holder vc_sep_holder_l"><span<?php echo crypterio_sanitize_text_field($inline_css); ?> class="vc_sep_line"></span></span>
		<?php if($title!=''): ?><h4><?php echo esc_html( $title ); ?></h4><?php endif; ?>
		<span class="vc_sep_holder vc_sep_holder_r"><span<?php echo crypterio_sanitize_text_field($inline_css); ?> class="vc_sep_line"></span></span>
	</div>
	<?php echo crypterio_sanitize_text_field($this->endBlockComment('separator')."\n"); ?>
<?php }else{ ?>
	<div class="<?php echo esc_attr(trim($css_class)); ?>">
		<?php if($title!=''): ?><h4><?php echo esc_html( $title ); ?></h4><?php endif; ?>
	</div>
