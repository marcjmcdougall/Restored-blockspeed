...
<div class="vacancy_table_wr<?php echo esc_attr( $css_class ); ?>">
	...
	<?php if ( $vacancies->have_posts() ) { ?>
		...
		<table class="vacancy_table" id="vacancy_table_<?php echo esc_attr( $id ) ?>">
			<thead>
			<tr>
				<th><?php esc_html_e( 'Job Posting Title', 'crypterio' ); ?></th>
				<th class="location"><?php esc_html_e( 'Location', 'crypterio' ); ?></th>
				<th><?php esc_html_e( 'Department', 'crypterio' ); ?></th>
				<th><?php esc_html_e( 'Date', 'crypterio' ); ?></th>
			</tr>
			</thead>
			<tbody>
