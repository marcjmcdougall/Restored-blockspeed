					...
					<li>
						...
						<?php else: ?>
							...
							<div class="staff_info">
								...
								<?php endif; ?>
								<?php if ( $style != 'grid' ) : ?>
									<a href="<?php the_permalink(); ?>" class="button bordered size-sm icon_right"><?php esc_html_e( 'view profile', 'crypterio' ); ?> <i class="fa fa-chevron-right"></i></a>
								<?php else: ?>
...
<?php if( $style == 'carousel' ): ?>
	<script type="text/javascript">
		jQuery(document).ready(function($) {
			...
			var arrows_en = <?php echo ($carousel_arrows) ? 'true' : 'false'; ?>;
