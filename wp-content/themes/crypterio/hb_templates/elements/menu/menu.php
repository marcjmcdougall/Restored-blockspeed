...
if (empty($element['data']['id'])) {
	$element['data']['id'] = 'crypterio-primary_menu';
}

if (!empty($element['data']['id'])):


	if(!empty($element['data']['hoverColor']) or !empty($element['data']['innerColor']) or !empty($element['data']['innerHoverColor']) ) {
