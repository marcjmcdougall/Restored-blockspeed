            ...
            <ul class="event-info__datetime" style="min-width: 134px;">
                ...
                <?php else: ?>
                    <?php if( !empty( $stm_event_time_start ) || !empty( $stm_event_time_end ) ) : ?>
                        <li><i class="fa fa-clock-o"></i> <?php echo (( $stm_event_time_end ) ? esc_html( $stm_event_time_start . ' ' . esc_html__('to', 'crypterio') . ' ' . $stm_event_time_end ) : esc_html( $stm_event_time_start ) ); ?></li>
                    <?php endif; ?>
                <?php endif; ?>
            </ul>
        <?php endif; ?>
