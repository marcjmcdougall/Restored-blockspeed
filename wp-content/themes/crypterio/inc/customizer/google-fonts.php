...
if (!function_exists('stm_get_google_fonts')) {
	function stm_get_google_fonts()
	{
		...
		$font_options[''] = esc_html__('--- Default ---', 'crypterio');

		foreach (crypterio_google_fonts_array() as $font_key => $font_data) {
...
if (!function_exists('crypterio_google_fonts_array')) {
	function crypterio_google_fonts_array()
	{
